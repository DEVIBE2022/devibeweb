...
export default function Testimonials() {
  ...
  return (
    <section
      className="bg-light-yellow flex pt-40 pb-[64rem]"
      id="testimonials"
    ...
    >
      ...
      <div className="overflow-hidden py-10" ref={triggerRef}>
        <div
          className="flex flex-row gap-20 mt-20 px-[6.25rem] relative"
          ref={reviewRef}
        >
          <div className="bg-black px-16 py-20 rounded-2xl">
            ...
            <div className="flex flex-row items-center gap-4 mt-8">
              ...
              <div
                ...
                style={{ flexDirection: "column" }}
              >
                <h3 className="font-regular text-lg text-white">Mike Warren</h3>
          ...
          <div className="bg-white px-16 py-20 rounded-2xl drop-shadow-lg">
            ...
            <div className="flex flex-row items-center gap-4 mt-8">
              ...
              <div
                ...
                style={{ flexDirection: "column" }}
              >
                <h3 className="font-regular text-lg text-black">Mike Warren</h3>
                <p className="font-regular text-lg text-other-gray opacity-90">
                  Product Manager at Zapier
                </p>
              </div>
